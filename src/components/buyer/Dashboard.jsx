...
const Dashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 relative">
      {/* Sidebar - positioned absolute or fixed when collapsed */}
      <Sidebar userRole="buyer" />
      
      {/* Main Content - takes full width with padding */}
      <div className="flex-1 py-8 px-4 ml-[72px] md:ml-[72px]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white shadow-md rounded-xl overflow-hidden mb-8">
            ...
            <div className="border-b border-gray-200">
              <nav className="flex gap-4 py-2 px-2">
                <button
                ...
                <button
                  ...
                  className={`px-6 py- text-sm font-medium flex items-center transition-colors ${
                    activeTab === 'pending'
                      ? 'text-green-600 border-b-2 border-green-600'
                      : 'text-gray-500 hover:text-green-600'
                  }`}
